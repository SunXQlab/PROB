...
pnames = { 'weights' 'alpha' 'Intercept_Flag' 'numlambda' 'lambdaratio' 'lambda' ...
    'dfmax' 'standardize' 'reltol' 'cv' 'mcreps' 'maxiter'...
    'predictornames' 'options'  };
dflts  = { []        1    1   100       LRdefault     []      ...
     []      true          1e-4    'resubstitution'  1  1e5 ...
     {}               [] };
[weights, alpha, Intercept_Flag, nLambda, lambdaRatio, lambda, ...
...
[B,Intercept,lambda,mse] = ...
    lassoFit_Sun(X,Y, ...
    weights,lambda,alpha,Intercept_Flag,dfmax,standardize,reltol,lambdaMax,ever_active,userSuppliedLambda,nullMSE,maxIter);
